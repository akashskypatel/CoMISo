...
set CMAKE_CONFIGURATION=%QT_BASE_CONFIG% -DGLUT_INCLUDE_DIR="%LIBPATH%\%ARCHITECTURE%\freeglut-2.8.1\include" -DGLUT_glut_LIBRARY="%LIBPATH%\%ARCHITECTURE%\freeglut-2.8.1\lib\freeglut.lib" -DGLEW_INCLUDE_DIR="%LIBPATH%\%ARCHITECTURE%\glew-1.10.0\include" -DGLEW_LIBRARY="%LIBPATH%\%ARCHITECTURE%\glew-1.10.0\lib\glew32.lib" -DBOOST_ROOT="%LIBPATH%/%ARCHITECTURE%/boost_1_59_0" -DBOOST_LIBRARYDIR="%LIBPATH%/%ARCHITECTURE%/boost_1_59_0/lib64-msvc-12.0" -DOPENFLIPPER_ENABLE_LICENSE_MANAGER=FALSE -DCGAL_INCLUDE_DIR="%LIBPATH%/%ARCHITECTURE%/CGAL-4.7/include" -DCGAL_LIBRARY_DIR="%LIBPATH%/%ARCHITECTURE%/CGAL-4.7/lib" -DCGAL_BIN_DIR="%LIBPATH%/%ARCHITECTURE%/CGAL-4.7/bin" -DOPENFLIPPER_ENABLE_LICENSE_KEY_GENERATOR=FALSE -DOPENFLIPPER_ENABLE_LICENSE_MANAGER=FALSE -DPOCO_DIR_SEARCH="%LIBPATH%/%ARCHITECTURE%/poco-1.6.1-all" -DPoco_LIBRARY_DIR="%LIBPATH%/%ARCHITECTURE%/poco-1.6.1-all/lib" -DPoco_LIBRARY_DIRs="%LIBPATH%/%ARCHITECTURE%/poco-1.6.1-all/bin"  -DPoco_INCLUDE_DIR="%LIBPATH%/%ARCHITECTURE%/poco-1.6.1-all/include"
